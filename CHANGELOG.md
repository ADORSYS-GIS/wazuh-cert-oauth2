## [0.4.2-rc1-test] - 2026-02-27

### 🐛 Bug Fixes

- *(ci)* Removed persisted credentials to fix duplicated auth header in peter-evans/create-pull-request
- *(ci)* Updated remotebranch for changelog pr creation
- *(ci)* Added write permissions for workflow

### ⚙️ Miscellaneous Tasks

- *(ci)* Added release notes and changelog generation
