...
if [ "$(uname -s)" != "Linux" ]; then
    printf "%s\n" "[ERROR] This uninstallation script is intended for Linux systems. Please use the appropriate script for your operating system." >&2
    exit 1
fi
...
WOPS_VERSION=${WOPS_VERSION:-"0.4.4"}
